...
export default function LoginPage() {
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#f3f8fc] text-zinc-950">
      <div
        aria-hidden="true"
        className="absolute -top-40 -right-32 size-[30rem] rounded-full bg-sky-200/50 blur-3xl"
      />
      <div
        aria-hidden="true"
        className="absolute -bottom-52 -left-40 size-[32rem] rounded-full bg-amber-100/75 blur-3xl"
      />
      ...
      <div className="relative mx-auto flex min-h-screen w-full max-w-6xl flex-col px-5 py-6 sm:px-8 lg:px-10">
        ...
        <div className="grid flex-1 items-center gap-12 py-12 lg:grid-cols-[1fr_29rem] lg:gap-20 lg:py-16">
          <section className="mx-auto max-w-xl lg:mx-0">
            <span className="flex size-14 items-center justify-center rounded-2xl bg-sky-100 text-sky-800 ring-1 ring-inset ring-sky-900/8">
